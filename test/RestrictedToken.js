var TokenMock = artifacts.require("RestrictedTokenMock.sol");
var Allow = artifacts.require("AllowRestrictingService.sol");
var Deny = artifacts.require("DenyRestrictingService.sol");
...
contract('RestrictedToken', function(accounts) {
  ...
  beforeEach(async function() {
    allow = await Allow.new();
    deny = await Allow.new();
    token = await TokenMock.new(accounts[0], 100, allow.address);
  });
